import project1 from '../../public/image/jobsearch.png'
                ...
                <div className='flex md:flex-row flex-col justify-around items-center gap-10 p-10 '>
                    ...
                    <div className='flex-1'>
                        <h1 className='text-xl font-bold mb-4'>
                            Hire Haven (Online Job search management)🔍
                        </h1>
                        <p>
                        Connects job seekers and employers with a user-friendly platform. Secure authentication, personalized dashboards, and detailed job postings. Explore top companies, read the blog, and find FAQs for a streamlined experience.
                        </p>
                        <div>
                        ...
                        <div className='flex justify-center mt-5 gap-10'>
                            <div className=''>
                                <a href="https://github.com/surovishimu/Hire-Haven-job-search" className="inline-flex items-center hover:text-purple-800 text-xl" target="_blank" rel="noopener noreferrer">
                            ...
                            <div>
                                <a href="https://job-search-service.netlify.app/" className="inline-flex items-center hover:text-purple-800 text-xl" target="_blank" rel="noopener noreferrer">
